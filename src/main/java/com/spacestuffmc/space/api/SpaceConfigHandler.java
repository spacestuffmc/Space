...
public class SpaceConfigHandler {
    ...
    public static boolean isHelmetGiven() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getBoolean("global.givehelmet", (Boolean) SpaceConfig.Defaults.HELMET_GIVEN.getDefault());
    ...
    public static boolean isSuitGiven() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getBoolean("global.givesuit", (Boolean) SpaceConfig.Defaults.SUIT_GIVEN.getDefault());
    ...
    public static String getHelmet() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getString("global.helmet", (String) SpaceConfig.Defaults.HELMET.getDefault());
    ...
    public static String getChestPlate() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getString("global.chestplate", (String) SpaceConfig.Defaults.CHESTPLATE.getDefault());
    ...
    public static String getLeggings() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getString("global.leggings", (String) SpaceConfig.Defaults.LEGGINGS.getDefault());
    ...
    public static String getBoots() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getString("global.boots", (String) SpaceConfig.Defaults.BOOTS.getDefault());
    ...
    public static String getArmorType() {
        String armorType = SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getString("global.armortype", (String) SpaceConfig.Defaults.ARMOR_TYPE.getDefault());
        ...
        if (!"id".equals(armorType) && Material.matchMaterial(armorType + "_HELMET") == null) {
            ...
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getString("global.armortype");
    ...
    public static boolean getStopDrowning() {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.CONFIG).getBoolean("global.drowning.stopdrowning", (Boolean) SpaceConfig.Defaults.STOPDROWNING.getDefault());
    ...
    public static String getPlanetsFile(String id) {
        ...
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getString("ids." + id + ".generation.planets-file", "planets.yml");
    }
    ...
    public static boolean getRequireHelmet(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".helmet.required", (Boolean) SpaceConfig.Defaults.REQUIRE_HELMET.getDefault());
    ...
    public static boolean getRequireSuit(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".suit.required", (Boolean) SpaceConfig.Defaults.REQUIRE_SUIT.getDefault());
    ...
    public static boolean forceNight(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".alwaysnight", (Boolean) SpaceConfig.Defaults.FORCE_NIGHT.getDefault());
    ...
    public static int getRoomHeight(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getInt("ids." + id + ".maxroomheight", (Integer) SpaceConfig.Defaults.ROOM_HEIGHT.getDefault());
    ...
    public static int getGlowstoneChance(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getInt("ids." + id + ".generation.glowstonechance", (Integer) SpaceConfig.Defaults.GLOWSTONE_CHANCE.getDefault());
    ...
    public static int getStoneChance(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getInt("ids." + id + ".generation.stonechance", (Integer) SpaceConfig.Defaults.STONE_CHANCE.getDefault());
    ...
    public static boolean getAsteroidsEnabled(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".generation.generateasteroids", (Boolean) SpaceConfig.Defaults.ASTEROIDS_ENABLED.getDefault());
    ...
    public static boolean getSatellitesEnabled(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".generation.generatesatellites", (Boolean) SpaceConfig.Defaults.SATELLITES_ENABLED.getDefault());
    ...
    public static int getSatelliteChance(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getInt("ids." + id + ".generation.satellitechance", (Integer) SpaceConfig.Defaults.SATELLITE_CHANCE.getDefault());
    ...
    public static boolean getGeneratePlanets(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".generation.generateplanets", (Boolean) SpaceConfig.Defaults.GENERATE_PLANETS.getDefault());
    ...
    public static boolean getGenerateSchematics(String id) {
        return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".generation.generateschematics", (Boolean) SpaceConfig.Defaults.GENERATE_SCHEMATICS.getDefault());
    ...
    public static int getSchematicChance(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getInt("ids." + id + ".generation.schematicchance", (Integer) SpaceConfig.Defaults.SCHEMATIC_CHANCE.getDefault());
    ...
    public static boolean getGenerateBlackHoles(String id) {
        ...
        if (id.equalsIgnoreCase("planets")  ) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getBoolean("ids." + id + ".generation.generateblackholes");
    ...
    public static int getBlackHoleChance(String id) {
        if (id.equalsIgnoreCase("planets")) {
            return SpaceConfig.getConfig(SpaceConfig.ConfigFile.IDS).getInt("ids." + id + ".generation.blackholechance");
